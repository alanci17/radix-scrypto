    ...
    impl CandyDex {
        ...
        pub fn unstock_candy(
            ...
            if candy_out_nbr <= total_candy {
                ...
                let delta_candy = candy_out_nbr-total_candy;
                candy_bucket = match self.candy_vaults.get_mut(&candy_addr) {
            ...
            let meta_candy_amnt = meta_candy.amount().clone();
            
            CandyDex::meta_burn(self, meta_candy);
            
            let output_badge = CandyDex::meta_amounts(self, meta_badge, meta_candy_amnt, dec!(1));
        ...
        pub fn get_candy_sell_amount_bexsc(
            ...
            let new_price = CandyDex::price_mod(self, xrd_amount/price, candy_addr, price, dec!(0));
        ...
        pub fn get_xrd_buy_amount_bxsec(
            ...
            let new_price = CandyDex::price_mod(self, candy_amnt, candy_addr, price, dec!(0));
        ...
        pub fn get_candy_buy_amount_bcsex(
            ...
            let new_price = CandyDex::price_mod(self, xrd_amnt/price, candy_addr, price, dec!(1));
        ...
        pub fn get_xrd_sell_amount_becsx(
            ...
            let new_price = CandyDex::price_mod(self,  candy_amount, candy_addr, price, dec!(1));
        ...
        pub fn buy_candy_sell_exact_candy(
            ...
            let (_nmbr,amount_in) = self.candyput_pri(dec!(0), dec!(1), addr_in, candy_out);
        ...
        pub fn buy_xrd_sell_exact_candy(&mut self, xrd_min: Decimal, candy_out: Bucket) -> Bucket {
            ...
            let new_price = CandyDex::price_mod(self, candy_out.amount(), addr, price_out, dec!(0));
        ...
        pub fn buy_exact_candy_sell_candy(
            ...
            (
                self.candyput_sec(amount_in, addr_in, Decimal::zero(), Decimal::one(), candy_out),
                self.candytake(amount_in, addr_in)
            )
        }
        ...
        pub fn buy_exact_xrd_sell_candy(
            ...
            let new_price = self.price_mod(xrd_input/price_out, addr, price_out, dec!(0));
